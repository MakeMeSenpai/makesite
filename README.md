...
[![Go Report Card](https://goreportcard.com/badge/github.com/MakeMeSenpai/makesite)](https://goreportcard.com/report/github.com/MakeMeSenpai/makesite)
...
- [ ] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] `I will use the google translate library. The documentation is located at https://pkg.go.dev/cloud.google.com/go/translate. My goal is to use it to give users the option to translate text files.`
